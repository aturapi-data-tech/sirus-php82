...
class AppMenu
{
    ...
    private static function definitions(callable $entry): array
    {
        ...
        return [
            ...
            $entry(['group' => 'Operasi', 'groupOrder' => 13, 'order' => 2, 'route' => 'transaksi.penunjang.kamar-operasi', 'title' => 'Transaksi Kamar Operasi', 'desc' => 'Tindakan operasi, tarif, & transfer biaya ke rawat inap', 'roles' => ['admin', 'manager umum', 'supervisor penunjang', 'perawat'], 'badge' => 'OK']),
