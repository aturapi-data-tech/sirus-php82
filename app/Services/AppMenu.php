...
class AppMenu
{
    ...
    private static function definitions(callable $entry): array
    {
        ...
        return [
            ...
            $entry(['group' => 'Apotek', 'groupOrder' => 9, 'order' => 7, 'route' => 'manajemen.rs.apotek-online.laporan-klaim', 'title' => 'Laporan Klaim Apotek Online', 'desc' => 'Monitoring rekap klaim obat PRB/kronis/kemo ke BPJS per periode + unduh CSV', 'roles' => ['admin', 'apoteker', 'manager medis'], 'badge' => 'APT-ONL']),
