...
class AppMenu
{
    ...
    private static function definitions(callable $entry): array
    {
        ...
        return [
            ...
            $entry(['group' => 'Penunjang', 'groupOrder' => 10, 'order' => 4, 'route' => 'transaksi.penunjang.kamar-operasi', 'title' => 'Transaksi Kamar Operasi', 'desc' => 'Tindakan operasi, tarif, & transfer biaya ke rawat inap', 'roles' => ['admin', 'manager umum', 'supervisor penunjang', 'perawat'], 'badge' => 'OK']),
            ...
            $entry(['group' => 'Sistem', 'groupOrder' => 15, 'order' => 12, 'route' => 'panduan-dev.koding-skill', 'title' => 'Katalog Skill', 'desc' => 'Daftar skill repo (.claude/skills/*) + kapan dibaca', 'roles' => ['admin'], 'badge' => 'DOC']),
        ];
    }
}
