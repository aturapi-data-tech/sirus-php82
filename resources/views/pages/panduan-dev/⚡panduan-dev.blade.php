                ...
                <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3 mt-8">
                            ...
                            <a href="{{ route('panduan-dev.koding-formulir-rm') }}" wire:navigate
                                class="ds-btn ds-btn-secondary">Tutorial Kode Formulir RM →</a>
                            <a href="{{ route('panduan-dev.rujukan-kompetensi') }}" wire:navigate
                                class="ds-btn ds-btn-secondary">Rujukan Kompetensi (SRBK) →</a>
            ...
            <section id="komponen" class="ds-band">
                ...
                <div class="ds-card-outline mb-6">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-5">
                        ...
                        <x-cetak-button wire:click="cetakDemo" label="Cetak" />
                    </div>
