                    ...
                    <section x-show="section === 'uji-kirim'" x-cloak>
                        ...
                        <div class="ds-card-outline" style="padding:16px 20px">
                            <div class="ds-body-sm">
                                ...
                                <br>Yang benar: lookup <span class="ds-code">immst_products.product_id_satusehat</span> lewat <span class="ds-code">productId</span> (<span class="ds-code">App\Support\ObatKfa</span>). RI sudah benar sejak awal.
                        ...
                        <div class="ds-card-outline" style="padding:16px 20px">
                            <div class="ds-body-sm">
                                ...
                                <span class="ds-code">App\Support\MedicationRequestItem::ambil()</span> menyusun ulang peta itu untuk kunjungan lama —
