...
new class extends Component {
    ...
    /** IRISAN dokumen: cabang `idrg` + empat skalar yang dipakai panduan & panel. */
    public array $idrg = [];
    public string $noSep = '';
     ...
     * guard if($rjNo) di template, jadi seluruh SFC iDRG ikut dihapus saat tutup, bukan tinggal
