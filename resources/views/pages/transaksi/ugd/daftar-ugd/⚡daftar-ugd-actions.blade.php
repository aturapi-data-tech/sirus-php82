...
new class extends Component {
    ...
    public function openCreate(array $rujukanMasuk = []): void
    {
        ...
        // Sebelum entryId dipindah ke formDaftar: rujukan mengubah Cara Masuk.
        ...
        $this->dispatch(($this->formDaftar['regNo'] ?? '') !== '' ? 'focus-cari-dokter-ugd' : 'focus-cari-pasien-ugd');
    }
    ...
    private function terapkanRujukanMasuk(array $rujukanMasuk): void
    {
        ...
        $this->formDaftar['regNo'] = $regNo;
        $this->formDaftar['regName'] = (string) ($rujukanMasuk['regName'] ?? '');
    ...
    private function updateJsonData(int|string $rjNo): void
    {
        ...
        if ($this->formMode === 'create') {
            ...
            $this->appendAdminLogUGD((int) $rjNo, 'Pendaftaran UGD - '
                ...
                . ($this->formDaftar['entryDesc'] ?? '-') . $asalRujukan);
    ...
    private function tautkanJanjiRujukan(int|string $rjNo): void
    {
        ...
        $regNo = (string) ($this->formDaftar['regNo'] ?? '');
    ...
    {
        $this->reset(['rjNo', 'formDaftar', 'dataPasien', 'rujukanMasuk']);
        $this->resetVersion();
