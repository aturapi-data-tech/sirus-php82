...
new class extends Component {
    ...
    public function kirimInti(string $rjNo): void
    {
        try {
            ...
            // Telaah lama (sebelum 21/08/2026) hanya punya 10 butir. Membiarkannya
            // lewat berarti lima pertanyaan Q0007 dijawab "Sesuai" padahal tak pernah
            // diajukan ke apoteker — mengarang isi rekam medis nasional.
            $belum = TelaahResepQ0007::butirBelumDijawab($telaah);
            if ($belum !== []) {
                $this->dispatch('toast', type: 'error', message: 'Belum bisa dikirim: butir "' . implode('", "', $belum) . '" belum dijawab. Buka Telaah Resep dan lengkapi dulu — mengirim sekarang akan mencatat jawaban yang tidak pernah diberikan.');
                return;
            }
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                @if (!empty($belumDijawab))
                    {{-- Telaah lama yang belum memuat lima butir Q0007 --}}
