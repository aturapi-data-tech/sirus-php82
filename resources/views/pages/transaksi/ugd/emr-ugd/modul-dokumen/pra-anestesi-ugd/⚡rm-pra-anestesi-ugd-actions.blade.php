                ...
                <div class="relative flex items-start justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                <h2 class="font-semibold text-base text-ink dark:text-gray-100">Pengkajian Pra Anestesi & Pra Sedasi</h2>
                                <p class="mt-0.5 text-xs text-muted dark:text-gray-400">PAB 4 / RM 50 — dokter anestesi</p>
                            </div>
                        </div>
