...
<div class="pt-0">
    ...
    <div class="mb-2">
        ...
        <x-textarea placeholder="Tuliskan keterangan surat sehat pasien..." class="mt-1 ml-2 max-w-2xl" :error="$errors->has('suket.suketSehat.suketSehat')"
            :disabled="$isFormLocked" wire:model.live="suket.suketSehat.suketSehat" rows="3" />
