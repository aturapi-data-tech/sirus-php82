...
new class extends Component {
    ...
    /**
     * IRISAN dokumen: hanya cabang `generalConsentPasienUGD`.
     *
    ...
    public function setPetugasPemeriksa(): void
    {
        ...
        try {
            DB::transaction(function () {
                ...
                $this->generalConsent = $data['generalConsentPasienUGD'] ?? [];
    ...
    public function save(): void
    {
        ...
        try {
            DB::transaction(function () {
                ...
                $data['generalConsentPasienUGD'] = array_replace($data['generalConsentPasienUGD'] ?? $this->getDefaultGeneralConsent(), $this->generalConsent ?? []);
...
<div>
    ...
    <x-modul-dokumen.kartu judul="General Consent"
        ...
        <x-slot:deskripsi>Persetujuan umum pasien terhadap pelayanan UGD, hak & tanggung jawab, serta perlindungan data.</x-slot:deskripsi>
        <x-slot:badge>
            @if ($gcSigned)
