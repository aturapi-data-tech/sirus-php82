                                ...
                                <div
                                    ...
                                    <div class="pt-3 border-t border-gray-100 dark:border-gray-800">
                                        <div class="flex items-center justify-between mb-2">
                                            <x-input-label value="Pihak yg Diberi Akses Info Medis"
                                                class="!mb-0" />
                                            @if (!$isFormLocked)
                                        ...
                                        <div class="space-y-2">
                                            @foreach ($pihakInfoMedis as $i => $row)
                                                <div wire:key="pihak-info-ugd-{{ $i }}"
                                                    ...
                                                    <x-text-input wire:model.live.debounce.500ms="pihakInfoMedis.{{ $i }}.nama"
                                                        placeholder="Nama" :disabled="$isFormLocked"
                                                        class="col-span-5 text-sm" />
                                                    <x-text-input wire:model.live.debounce.500ms="pihakInfoMedis.{{ $i }}.hubungan"
                                                        placeholder="Hubungan (cth: anak, istri)" :disabled="$isFormLocked"
                                                        class="col-span-4 text-sm" />
                                                    <x-text-input wire:model.live.debounce.500ms="pihakInfoMedis.{{ $i }}.noHp"
