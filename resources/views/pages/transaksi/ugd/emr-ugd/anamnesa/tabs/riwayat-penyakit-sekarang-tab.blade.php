...
<x-border-form :title="__('Riwayat Penyakit Sekarang')" :align="__('start')" :bgcolor="__('bg-surface-soft')">
    <div class="">
        <x-textarea wire:model.live="anamnesa.riwayatPenyakitSekarangUmum.riwayatPenyakitSekarangUmum"
            placeholder="Deskripsi Anamnesis" :error="$errors->has('anamnesa.riwayatPenyakitSekarangUmum.riwayatPenyakitSekarangUmum')" :disabled="$isFormLocked" :rows="3" class="w-full" />
