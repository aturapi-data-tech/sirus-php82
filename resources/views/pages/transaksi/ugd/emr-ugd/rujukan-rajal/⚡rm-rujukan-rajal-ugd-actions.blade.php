...
new class extends Component {
    ...
    public function mount(): void
    {
        ...
        $tersimpan = $dataDaftarUGD['rujukanKompetensiRajal'] ?? [];
    ...
    public function openModal(): void
    {
        ...
        $this->dispatch('open-modal', name: 'rujukan-rajal-ugd-' . $this->rjNo);
    }

    public function closeModal(): void
    {
        $this->dispatch('close-modal', name: 'rujukan-rajal-ugd-' . $this->rjNo);
    }
    ...
    private function simpanDraft(?string $catatanAudit = null): void
    {
        ...
        try {
            DB::transaction(function () use ($catatanAudit) {
                ...
                $data['rujukanKompetensiRajal'] = $this->formRujukan;
...
<div>
    ...
    {{-- ══ MODAL FORMULIR ══ --}}
    <x-modal name="rujukan-rajal-ugd-{{ $rjNo }}" size="full" height="full" focusable>
            ...
            <div class="grid grid-cols-1 gap-3">
                <div>
                    <livewire:lov.poli.lov-poli label="Poli Rujukan (kode BPJS 3 huruf)"
                        ...
                        wire:key="lov-poli-poli-rujukan-rajal-ugd-{{ $rjNo }}" />
                    <p class="mt-1 text-xs text-muted-soft">
