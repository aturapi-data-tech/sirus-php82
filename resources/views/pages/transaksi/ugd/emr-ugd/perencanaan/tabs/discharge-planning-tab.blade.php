...
<div class="space-y-4">
    ...
    <x-border-form :title="__('Pelayanan Berkelanjutan')" :align="__('start')" :bgcolor="__('bg-surface-soft')">
            ...
            <div>
                ...
                <div class="mt-1">
                    <x-select-input
                        ...
                        @foreach ($perencanaan['dischargePlanning']['pelayananBerkelanjutan']['pelayananBerkelanjutanOption'] ?? [] as $option)
        ...
        'kemoterapi' => 'Kemoterapi',
                        ...
                        <div class="flex items-center space-x-2">
                            <x-toggle
                                wire:model.live="perencanaan.dischargePlanning.pelayananBerkelanjutanOpsi.{{ $field }}"
    ...
    <x-border-form :title="__('Penggunaan Alat Bantu')" :align="__('start')" :bgcolor="__('bg-surface-soft')">
            ...
            <div>
                ...
                <div class="mt-1">
                    <x-select-input
                        ...
                        :disabled="$isFormLocked" :error="$errors->has(
                            'perencanaan.dischargePlanning.penggunaanAlatBantu.penggunaanAlatBantu',
                        )">
                        <option value="">Pilih Status</option>
                        @foreach ($perencanaan['dischargePlanning']['penggunaanAlatBantu']['penggunaanAlatBantuOption'] ?? [] as $option)
        ...
        'colostomy' => 'Colostomy',
                        ...
                        <div class="flex items-center space-x-2">
                            <x-toggle
                                wire:model.live="perencanaan.dischargePlanning.penggunaanAlatBantuOpsi.{{ $field }}"
                                trueValue="1" falseValue="0" :disabled="$isFormLocked">
                                {{ $label }}
                            </x-toggle>
                        </div>
