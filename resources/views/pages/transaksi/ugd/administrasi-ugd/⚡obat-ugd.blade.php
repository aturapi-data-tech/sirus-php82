                                ...
                                <tr wire:key="obat-row-{{ $item['rjobatDtl'] }}-edit" x-data
                                    ...
                                    <td colspan="{{ $isFormLocked ? 7 : 8 }}" class="px-3 py-3">
                                        ...
                                        <div class="flex flex-wrap items-end gap-2">
                                            ...
                                            <div class="w-24">
                                                <x-input-label value="Etiket" class="mb-1" />
                                    <x-cetak-button wire:click="cetakEtiketItem({{ $item['rjobatDtl'] }})" label="Etiket" title="Cetak etiket obat ini" />
                                            </div>
                                            @if (!$isFormLocked)
                                                <div class="flex items-center gap-2 pb-0.5 shrink-0">
                                    ...
                                    @if (!$isFormLocked)
                                        <td class="px-3 py-1.5 whitespace-nowrap">
                                            <div class="flex items-center gap-1">
                                                ...
                                                <x-hapus-button wire:click.prevent="removeObat({{ $item['rjobatDtl'] }})" confirm="Hapus obat ini?" />
                                            </div>
                                        </td>
                                    @endif
                                </tr>
