...
new class extends Component {
     ...
     * (`wire:model="eresepRacikan.<i>.qty"`, dan diakses Alpine lewat `$wire.eresepRacikan[<i>]`).
     *
    ...
    public function removeProduct(int $rjObatDtl): void
    {
        ...
        try {
            DB::transaction(function () use ($rjObatDtl) {
                ...
                $obatExists = collect($this->eresepRacikan ?? [])->contains('rjObatDtl', $rjObatDtl);
                                                ...
                                                @isset($eresep['jenisKeterangan'])
                                                    ...
                                                    <tr wire:key="eresep-rj-racikan-{{ $key }}"
                                                        ...
                                                        <td class="px-4 py-3 text-center">
                                                            @role(['Dokter', 'Admin'])
                                                                <x-hapus-button wire:click.prevent="removeProduct('{{ $eresep['rjObatDtl'] }}')" :disabled="$isFormLocked" confirm="Hapus obat racikan ini?" title="Hapus obat" />
                                                            @endrole
                                                        </td>
                                                    </tr>
