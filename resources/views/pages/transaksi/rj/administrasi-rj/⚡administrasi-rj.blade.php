            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    ...
                    @if (!in_array($rjStatus, ['A', 'F']))
                        ...
                        <x-cetak-button wire:click="cetakKwitansiObat" label="Cetak Kwitansi Obat" />
                        ...
                        @if ($statusKronisHdr === 'Y')
                            ...
                            <x-cetak-button wire:click="cetakKwitansiBpjs" label="Cetak Kwitansi BPJS" />

                            {{-- Cetak Kwitansi Obat Kronis (qty kronis) --}}
                            <x-cetak-button wire:click="cetakKwitansiObatKronis" label="Cetak Obat Kronis" />
                        @endif

                        {{-- Cetak Resep Iter — muncul saat header status_iter='Y' --}}
                        @if ($statusIterHdr === 'Y')
                            <x-cetak-button wire:click="cetakResepIter" label="Cetak Resep Iter" />
                        @endif

                        {{-- Cetak Kwitansi --}}
                        <x-cetak-button wire:click="cetakKwitansi" label="Cetak Kwitansi" />
                    @endif
