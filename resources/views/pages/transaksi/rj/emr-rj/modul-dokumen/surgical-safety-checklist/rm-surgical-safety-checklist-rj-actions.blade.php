...
new class extends Component {
    ...
    public function cetak(string $createdAt)
    {
        ...
        try {
            ...
            set_time_limit(300);
            $pdf = Pdf::loadView('pages.components.modul-dokumen.r-i.surgical-safety-checklist-rj.cetak-surgical-safety-checklist-rj-print', ['data' => $data])->setPaper('A4');
        ...
        <div class="flex flex-col min-h-[calc(100vh-8rem)]" wire:key="{{ $this->renderKey('modal-surgical-safety-checklist-rj', [$rjNo ?? 'new']) }}">
            ...
            <div class="flex-1 px-4 py-4 bg-surface-soft/70 dark:bg-gray-950/20">
                <div class="max-w-full mx-auto space-y-4">
                    <livewire:pages::transaksi.ri.display-pasien-rj.display-pasien-rj :rjNo="$rjNo" wire:key="ssc-rj-display-pasien-{{ $rjNo ?? 'init' }}" />
