                ...
                <div class="relative flex items-center gap-3 min-w-0">
                    <div class="flex items-center flex-1 gap-3 min-w-0">
                        <div class="flex items-center gap-2.5 min-w-0">
                            <div class="flex items-center justify-center w-7 h-7 rounded-lg shrink-0 bg-fuchsia-500/10">
                                                    ...
                                                    <td class="px-4 py-3 text-center align-middle whitespace-nowrap" @click.stop>
                                                        <div class="flex flex-wrap items-center justify-center gap-1.5">
                                                            ...
                                                            @if (!$isFormLocked)
                                                                ...
                                                                @endif
                                                                @can('dokumen.hapus')
                                                                <x-hapus-button wire:click.prevent="hapus('{{ $rowKey }}')" confirm="Yakin hapus asesmen ini?" />
                                                                @endcan
                                                                </div>
                                                            @endif
                                                        </div>
