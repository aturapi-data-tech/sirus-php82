        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @if ($icCount > 0)
                        <x-badge class="shrink-0 whitespace-nowrap" variant="success">{{ $icCount }} tindakan</x-badge>
                    @else
                ...
                <div class="relative flex items-center gap-3 min-w-0">
                    <div class="flex items-center flex-1 gap-3 min-w-0">
                        ...
                        <div class="flex items-center gap-1.5 ml-auto shrink-0">
                            ...
                            @if ($icCount > 0)
                                <x-badge class="shrink-0 whitespace-nowrap" variant="info">{{ $icCount }} tersimpan</x-badge>
                            @endif
                            @if ($isFormLocked)
