        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <p class="hidden truncate text-sm text-muted sm:block dark:text-gray-400">Instruksi pasca-bedah/anestesi (RM 56, PAB 7.3): penanganan nyeri, mual/muntah, antibiotik, obat, minum, infus, monitor tanda vital. Diisi &amp; ditandatangani ahli anestesiologi. Tiap entri = 1 instruksi.</p>
                </div>
            </div>
            ...
            <div class="mt-3 overflow-x-auto rounded-2xl border border-hairline dark:border-gray-700">
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        @forelse (array_reverse($instruksiList) as $e)
                                ...
                                <table class="min-w-full text-sm">
                                    <thead class="sticky top-0 z-10 bg-surface-card dark:bg-gray-800">
                                        <tr class="text-xs font-semibold tracking-wide text-left text-muted uppercase dark:text-gray-300">
                                            ...
                                            <th class="px-4 py-3 border-b bg-surface-card dark:bg-gray-800">Ringkasan</th>
                                    ...
                                    @forelse (array_reverse($instruksiList) as $entry)
                                        @php
