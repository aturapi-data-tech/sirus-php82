        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 space-y-3">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    <p class="hidden truncate text-sm text-muted sm:block dark:text-gray-400">WHO Surgical Safety Checklist — verifikasi tiga fase: Sign In (sebelum anestesi), Time Out (sebelum insisi), dan Sign Out (sebelum meninggalkan kamar operasi).</p>
                </div>
                @if ($entriCount > 0)
