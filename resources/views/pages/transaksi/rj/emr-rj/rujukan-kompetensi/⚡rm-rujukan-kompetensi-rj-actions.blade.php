...
new class extends Component {
     ...
     */
    #[On('lov.selected.rujukanRajalWilayahRJ')]
            ...
            <div class="flex-1 px-4 py-4 overflow-y-auto bg-surface-soft dark:bg-gray-950/20">
                <div class="max-w-full mx-auto space-y-4">
                    ...
                    <livewire:pages::transaksi.rj.display-pasien-rj.display-pasien-rj :rjNo="$rjNo"
                        wire:key="rujukan-kompetensi-rj-display-pasien-{{ $rjNo ?? 'init' }}" />
            ...
            @if (!empty($formRujukan['kriteriaList']))
                ...
                <div>
                    <livewire:lov.kabupaten.lov-kabupaten label="Jejaring Wilayah Rujukan (Kab/Kota)"
                        target="rujukanRajalWilayahRJ" :initialKabId="$formRujukan['kodeKabupaten'] ?: null"
                        :readonly="$isFormLocked"
                        wire:key="lov-wilayah-rujukan-rajal-rj-{{ $rjNo }}" />
                    <p class="mt-1 text-xs text-muted-soft">
                        Terpilih:
