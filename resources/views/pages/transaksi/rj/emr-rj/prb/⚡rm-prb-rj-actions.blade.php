                                                ...
                                                <tr class="border-t border-hairline-soft dark:border-gray-700">
                                                    ...
                                                    @if (!$isFormLocked)
                                                        <td class="px-2 py-1 text-center">
                                                            <x-hapus-button wire:click="hapusObat({{ $idx }})" confirm="Hapus obat ini?" />
                                                        </td>
                                                    @endif
                                                </tr>
                                            @endforeach
                        ...
                        <div class="space-y-4">
                            ...
                            @if (!empty($formPRB['noSrb']))
                                <div class="flex justify-end">
                                    <x-cetak-button wire:click="cetakPRB" label="Cetak Surat Rujuk Balik" />
                                </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between pt-3">
                                ...
                                @if (!$isFormLocked)
                                    <div class="flex gap-2">
                                        @if (!empty($formPRB['noSrb']))
                                            <x-hapus-button wire:click="hapusPRB" confirm="Yakin hapus PRB {{ $formPRB['noSrb'] }} dari BPJS?" label="Hapus PRB" />
                                        @endif
