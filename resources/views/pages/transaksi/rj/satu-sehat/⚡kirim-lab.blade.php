        ...
        try {
            ...
            foreach ($checkups as $checkup) {
                ...
                $serviceRequest = $this->postServiceRequest([
                    'identifier' => ['system' => "http://sys-ids.kemkes.go.id/servicerequest/{$orgId}", 'value' => "{$rjNo}-{$checkupNo}"],
                ...
                $specimen = $this->postSpecimen([
                    'identifier' => ['system' => "http://sys-ids.kemkes.go.id/specimen/{$orgId}", 'value' => "{$rjNo}-{$checkupNo}", 'assigner' => "Organization/{$orgId}"],
                ...
                $dokter = $this->createDiagnosticReport([
                    'identifier' => [['system' => "http://sys-ids.kemkes.go.id/diagnostic/{$orgId}", 'use' => 'official', 'value' => "{$rjNo}-{$checkupNo}"]],
