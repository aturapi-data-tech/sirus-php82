...
//   screening.kesadaran   → tunggal: 'Sadar' | 'Mengantuk / Gelisah' | 'Tidak Sadar'
//
...
//
// CATATAN: GCS TIDAK ikut di sini. EMR RJ memang punya field bernama 'gcs', tapi
// itu milik blok pemeriksaan penunjang 'emg' (Elektromiografi), bukan penilaian
// kesadaran umum — mengirimnya sebagai Glasgow Coma Score akan salah makna.
...
new class extends Component {
    ...
    public function kirimInti(string $rjNo): void
    {
        try {
            ...
            $kesadaran = trim((string) ($dataRJ['screening']['kesadaran'] ?? ''));
