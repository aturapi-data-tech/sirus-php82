                                                ...
                                                @else
                                                    <tr wire:key="ri-resep-obat-{{ $item['slsDtl'] ?? $loop->index }}"
                                                        ...
                                                        <td class="px-3 py-1.5 text-center whitespace-nowrap">
                                                            <x-cetak-button wire:click="cetakEtiketItem({{ $item['slsDtl'] }})" label="Etiket" title="Cetak etiket obat ini" />
                                                        </td>
                                                        ...
                                                        <td class="px-3 py-1.5 whitespace-nowrap">
                                                            @if (!$this->isObatLocked)
                                                                <div class="flex items-center justify-center gap-1">
                                                                    ...
                                                                    <x-hapus-button wire:click.prevent="removeObat({{ $item['slsDtl'] }})" confirm="Hapus obat ini?" />
                                                                </div>
                                                            @else
