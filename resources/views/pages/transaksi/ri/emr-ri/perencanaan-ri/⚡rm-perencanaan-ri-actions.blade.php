...
<div class="space-y-4" wire:key="{{ $this->renderKey('modal-perencanaan-ri', [$riHdrNo ?? 'new']) }}"
    ...
    <x-border-form title="Tindak Lanjut / Rencana Pulang" align="start" bgcolor="bg-surface-soft">
        <div class="mt-3 space-y-4">
            ...
            @if (($perencanaan['tindakLanjut']['tindakLanjut'] ?? '') === '306206005')
                                ...
                                <tbody>
                                    @foreach ($rowsPelayanan as $i => $row)
                                        <tr>
                                            ...
                                            <td class="ds-c">
                                                @if (!$isFormLocked)
                                                    <x-hapus-button :action="'hapusPelayanan(' . $i . ')'" title="Hapus Pelayanan" :message="'Yakin hapus ' . ($row['jenisPelayanan'] ?? 'entri ini') . '?'" />
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <tbody>
                                    @foreach ($rowsAlat as $i => $row)
                                        <tr>
                                            ...
                                            <td class="ds-c">
                                                @if (!$isFormLocked)
                                                    <x-hapus-button :action="'hapusAlat(' . $i . ')'" title="Hapus Alat Bantu" :message="'Yakin hapus ' . ($row['jenisAlat'] ?? 'entri ini') . '?'" />
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
