        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 min-w-0 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <x-deskripsi-ringkas class="hidden sm:flex text-sm">Pengkajian awal pasien ginekologi (RM 45/45.a) — identitas & sosial, riwayat ginekologi & haid, keluhan, TTV, pemeriksaan dalam & status lokalis, skrining (PP 1.2), diagnosa & rencana. Diisi Bidan/Dokter.</x-deskripsi-ringkas>
                </div>
            </div>
                ...
                <div class="flex items-center gap-3 min-w-0 flex-1 min-w-0">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div class="flex items-baseline gap-2 min-w-0">
                            <h2 class="text-sm truncate shrink-0 font-semibold text-ink dark:text-gray-100">Pengkajian Awal Ginekologi</h2>
                            <p class="flex-1 min-w-0 truncate text-xs text-muted dark:text-gray-400">RM 45 / 45.a — kebidanan (VK). Diisi Bidan / Dokter.</p>
                        </div>
                    </div>
