        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <p class="hidden truncate text-sm text-muted sm:block dark:text-gray-400">Pengkajian awal pasien obstetri (RM 44/44.a) — identitas & sosial, status obstetri (G-P-A), riwayat persalinan, TTV, pemeriksaan dalam, skrining (PP 1.2), diagnosa & rencana. Diisi Bidan/Dokter.</p>
                </div>
            </div>
