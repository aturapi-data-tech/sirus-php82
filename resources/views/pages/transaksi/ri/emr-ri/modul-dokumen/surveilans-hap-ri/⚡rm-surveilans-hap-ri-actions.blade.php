        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 min-w-0 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <x-deskripsi-ringkas class="hidden sm:flex text-sm">Pemantauan pneumonia yang timbul selama perawatan TANPA ventilator — lama tirah baring, demam, leukosit, onset baru sputum purulen, serta kultur sputum. Diisi IPCLN / Perawat ruangan.</x-deskripsi-ringkas>
                </div>
            </div>
