        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 min-w-0 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <p class="flex-1 min-w-0 hidden truncate text-sm text-muted sm:block dark:text-gray-400">Pemantauan pneumonia yang timbul selama perawatan TANPA ventilator — lama tirah baring, demam, leukosit, onset baru sputum purulen, serta kultur sputum. Diisi IPCLN / Perawat ruangan.</p>
                </div>
            </div>
                    ...
                    <x-border-form padding="p-0">
                        ...
                        @empty
                            <div class="flex flex-col items-center justify-center gap-3 px-6 py-12">
                                ...
                                <p class="text-base font-medium text-muted dark:text-gray-400">Belum ada entri surveilans pneumonia non-ventilator.</p>
                            </div>
                        @endforelse
                    </x-border-form>
                    @endunless
