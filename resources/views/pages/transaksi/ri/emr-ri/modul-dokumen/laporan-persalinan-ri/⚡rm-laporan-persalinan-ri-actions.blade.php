...
<div>
    ...
    <x-modul-dokumen.kartu judul="Laporan Tindakan Persalinan"
        :jumlah="$lpCount"
        satuan="entri"
        :nonaktif="$disabled || !$riHdrNo">
        <x-slot:deskripsi>Laporan tindakan persalinan (RM 44.c) — jenis partus, data bayi &amp; APGAR, plasenta, tali pusat, selaput janin, perlukaan jalan lahir, Kala IV, serta IMD/Rawat Gabung/ASI (PONEK/Prognas 1). Diisi Dokter.</x-slot:deskripsi>
    ...
    <x-modal name="laporan-persalinan-ri" size="full" height="full" focusable>
        <div class="flex flex-col min-h-full"
            ...
            <x-modul-dokumen.header judul="Laporan Tindakan Persalinan"
                ...
                RM 44.c — kebidanan (VK). Tiap entri = 1 laporan. Diisi Dokter.
            ...
            <div class="flex-1 px-4 py-4 overflow-y-auto bg-surface-soft dark:bg-gray-950/20">
                <div class="max-w-full mx-auto space-y-4">
                        ...
                        <x-border-form title="2. Bayi">
                            <div class="space-y-3">
                                <div class="overflow-x-auto bg-canvas border rounded-2xl border-hairline dark:border-gray-700">
                                    <table class="ds-table ds-table-entri min-w-[1900px]">
                                        <thead>
                                            <tr>
                    ...
                    @endif
                    @unless ($this->diForm())
                    <x-modul-dokumen.tabel-daftar :kolom="['', 'Tgl / Jam', 'Jenis Partus', 'Petugas (TTD)', 'Status' => 'text-center', 'Aksi' => 'text-center']">
