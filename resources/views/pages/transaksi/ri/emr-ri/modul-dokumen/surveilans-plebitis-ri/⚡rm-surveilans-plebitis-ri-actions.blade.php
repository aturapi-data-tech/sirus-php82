        ...
        <div class="flex flex-col min-h-full"
            ...
            <div class="flex-1 px-4 py-4 overflow-y-auto bg-surface-soft/70 dark:bg-gray-950/20">
                <div class="w-full space-y-4">
                    ...
                    @endif
                    @unless ($this->diForm())
                    <x-modul-dokumen.tabel-daftar :kolom="['', 'Tanggal', 'Akses Vaskular', 'Dokter yang Merawat', 'Petugas (TTD)', 'Status' => 'text-center', 'Aksi' => 'text-center w-64']">
                                ...
                                @empty
                                    <x-modul-dokumen.baris-kosong :kolom="7" pesan="Belum ada entri surveilans IADP &amp; plebitis." />
                                @endforelse
