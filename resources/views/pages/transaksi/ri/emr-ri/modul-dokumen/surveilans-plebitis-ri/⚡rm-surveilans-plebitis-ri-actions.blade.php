                    ...
                    <x-border-form padding="p-0">
                        ...
                        @empty
                            <div class="flex flex-col items-center justify-center gap-3 px-6 py-12">
                                ...
                                <p class="text-base font-medium text-muted dark:text-gray-400">Belum ada entri surveilans IADP &amp; plebitis.</p>
                            </div>
                        @endforelse
                    </x-border-form>
                    @endunless
