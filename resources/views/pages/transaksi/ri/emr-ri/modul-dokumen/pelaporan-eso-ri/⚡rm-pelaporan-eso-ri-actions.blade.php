...
new class extends Component {
    ...
    private function snapshotIdentitasPenderita(): void
    {
        ...
        $potret('penderita.tglMrs', data_get($this->dataDaftarRi, 'entryDate', ''));
    }
    ...
    private function prefillDariEmr(): void
    {
        ...
        $isi('penderita.penyakitUtama', (string) data_get($this->dataDaftarRi, 'pengkajianAwalPasienRawatInap.bagian1DataUmum.diagnosaMasuk', ''));
        $isi('penderita.beratBadan', (string) data_get($this->dataDaftarRi, 'pengkajianAwalPasienRawatInap.bagian4PemeriksaanFisik.tandaVital.bb', ''));
