                ...
                <div class="flex items-center gap-3 min-w-0">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div class="flex items-baseline gap-2 min-w-0">
                            ...
                            <p class="truncate text-xs text-muted dark:text-gray-400">RM 08.c — neonatal (VK). Tiap entri = 1 baris catatan. Diisi Dokter &amp; Perawat/Bidan.</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                                ...
                                <table class="min-w-full text-sm border border-hairline rounded-lg dark:border-gray-700">
                                    <thead class="sticky top-0 z-10 bg-surface-card dark:bg-gray-800">
                                        <tr class="text-xs font-semibold tracking-wide text-left text-muted uppercase dark:text-gray-300">
                                            ...
                                            <th class="px-4 py-3 border-b bg-surface-card dark:bg-gray-800">Jenis</th>
