        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <x-deskripsi-ringkas class="hidden sm:flex text-sm">Formulir permintaan pendampingan pelayanan kerohanian sesuai agama/kepercayaan pasien selama Rawat Inap. Dapat lebih dari satu catatan.</x-deskripsi-ringkas>
                </div>
