        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 min-w-0 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    <h3 class="truncate shrink-0 text-base font-semibold text-ink dark:text-gray-200">Pengkajian Awal Bayi</h3>
                    @if ($paCount > 0)
                    ...
                    @endif
                    <x-deskripsi-ringkas class="hidden sm:flex text-sm">Pengkajian awal bayi baru lahir (RM 14 e.3) — identitas bayi, nilai APGAR (1'/5'/10'), pemeriksaan fisik, antropometri, keadaan waktu lahir, diagnosa &amp; rencana. Diisi Dokter.</x-deskripsi-ringkas>
                </div>
            </div>
                ...
                <div class="flex items-center gap-3 min-w-0 flex-1 min-w-0">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div class="flex items-baseline gap-2 min-w-0">
                            <h2 class="text-sm truncate shrink-0 font-semibold text-ink dark:text-gray-100">Pengkajian Awal Bayi</h2>
                            <p class="flex-1 min-w-0 truncate text-xs text-muted dark:text-gray-400">RM 14 e.3 — kebidanan (VK). Tiap entri = 1 bayi. Diisi Dokter.</p>
                        </div>
                    </div>
