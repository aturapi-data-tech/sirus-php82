...
<div>
    ...
    <x-modul-dokumen.kartu judul="Instruksi Pasca Bedah"
        :jumlah="$ipbCount"
        satuan="instruksi"
        :nonaktif="$disabled || !$riHdrNo">
        <x-slot:deskripsi>Instruksi pasca-bedah/anestesi (RM 56, PAB 7.3): penanganan nyeri, mual/muntah, antibiotik, obat, minum, infus, monitor tanda vital. Diisi &amp; ditandatangani ahli anestesiologi. Tiap entri = 1 instruksi.</x-slot:deskripsi>
        ...
        <div class="flex flex-col min-h-full"
            ...
            <div class="flex-1 px-4 py-4 overflow-y-auto bg-surface-soft/70 dark:bg-gray-950/20">
                <div class="max-w-full mx-auto space-y-4">
                    ...
                    @endif
                    @unless ($this->diForm())
                    <x-modul-dokumen.tabel-daftar :kolom="['', 'Tgl / Jam', 'Ringkasan', 'Petugas (TTD)', 'Status' => 'text-center', 'Aksi' => 'text-center']">
                                            ...
                                            <tr @click="open = !open"
                                                ...
                                                <td class="px-4 py-3 text-center align-middle whitespace-nowrap" @click.stop>
                                                    <x-modul-dokumen.aksi-entri kunci="{{ $rowKey }}" :final="$isFinal" :terkunci="$isFormLocked"
                                                        ...
                                                        judulBukaKunci="Buka Kunci Instruksi Pasca Bedah"
                                                        konfirmasiHapus="Yakin hapus instruksi ini?" />
                                                </td>
                                            </tr>
