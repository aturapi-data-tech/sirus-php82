                    ...
                    <fieldset @disabled($formRO) class="space-y-4">
                        ...
                        <x-border-form title="4. Kultur Aspirat / Biopsi" :collapsible="true" :open="false">
                            <div class="space-y-3">
                                ...
                                <x-surveilans.kultur-list list="kulturAspiratHasil" title="Hasil Kultur Aspirat / Biopsi"
                                    :rows="$newForm['kulturAspiratHasil'] ?? []" :baris="$barisKultur['kulturAspiratHasil'] ?? []"
