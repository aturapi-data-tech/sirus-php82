                                    ...
                                    <table class="min-w-full text-base">
                                        <thead class="sticky top-0 z-10 bg-surface-card dark:bg-gray-800">
                                            <tr class="text-xs font-semibold tracking-wide text-left text-muted uppercase dark:text-gray-300">
                                                ...
                                                <th class="px-4 py-3 border-b bg-surface-card dark:bg-gray-800">Tgl Operasi</th>
                                                <th class="px-4 py-3 border-b bg-surface-card dark:bg-gray-800">Tindakan</th>
                                                <th class="px-4 py-3 border-b bg-surface-card dark:bg-gray-800">Operator (TTD)</th>
