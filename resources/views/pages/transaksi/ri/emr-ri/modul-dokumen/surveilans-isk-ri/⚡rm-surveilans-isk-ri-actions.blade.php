...
<div>
    ...
    <x-modul-dokumen.kartu judul="Surveilans Infeksi Saluran Kemih"
        :jumlah="$jumlahEntri"
        satuan="entri"
        :nonaktif="$disabled || !$riHdrNo">
        <x-slot:deskripsi>Pemantauan ISK terkait pemasangan kateter urin (SPP / douer / intermiten / kondom) — lama pemasangan, tanda infeksi per kelompok usia, pemeriksaan leukosit urin &amp; biakan urin. Diisi IPCLN / Perawat ruangan.</x-slot:deskripsi>
