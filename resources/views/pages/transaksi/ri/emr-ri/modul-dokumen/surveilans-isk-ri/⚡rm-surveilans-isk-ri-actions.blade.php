        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 min-w-0 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <p class="flex-1 min-w-0 hidden truncate text-sm text-muted sm:block dark:text-gray-400">Pemantauan ISK terkait pemasangan kateter urin (SPP / douer / intermiten / kondom) — lama pemasangan, tanda infeksi per kelompok usia, pemeriksaan leukosit urin &amp; biakan urin. Diisi IPCLN / Perawat ruangan.</p>
                </div>
            </div>
