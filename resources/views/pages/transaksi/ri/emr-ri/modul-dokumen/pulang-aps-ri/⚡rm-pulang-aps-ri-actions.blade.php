        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <x-deskripsi-ringkas class="hidden sm:flex text-sm">Surat pernyataan pasien/keluarga yang meminta pulang sebelum perawatan dinyatakan selesai, setelah mendapat penjelasan dokter/petugas. Dapat lebih dari satu surat.</x-deskripsi-ringkas>
                </div>
                ...
                <div class="mt-3 overflow-x-auto rounded-2xl border border-hairline dark:border-gray-700">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                            @forelse (array_reverse($apsList) as $po)
                ...
                <div class="relative flex items-center gap-3 min-w-0">
                    <div class="flex items-center flex-1 gap-3 min-w-0">
                        ...
                        <div class="flex items-center gap-1.5 ml-auto shrink-0">
                            ...
                            @if (count($apsList) > 0)
                                <x-badge class="shrink-0 whitespace-nowrap" variant="info">{{ count($apsList) }} tersimpan</x-badge>
                            @endif
                            @if ($isFormLocked)
                                ...
                                <table class="min-w-full text-base">
                                    <thead class="sticky top-0 z-10 bg-surface-card dark:bg-gray-800">
                                        <tr class="text-xs font-semibold tracking-wide text-left text-muted uppercase dark:text-gray-300">
                                            ...
                                            <th class="whitespace-nowrap px-4 py-3 border-b bg-surface-card dark:bg-gray-800">Alasan Pulang</th>
