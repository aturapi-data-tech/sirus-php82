        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 space-y-2">
                ...
                <div class="flex items-baseline flex-1 gap-2 min-w-0">
                    ...
                    @endif
                    <p class="hidden truncate text-sm text-muted sm:block dark:text-gray-400">Asesmen pasien terminal &amp; keluarganya: kondisi medis, simptom, psikososial-spiritual, rencana &amp; intervensi (termasuk DNR), lalu ditandatangani pasien/keluarga, saksi, dan petugas.</p>
                </div>
            </div>
