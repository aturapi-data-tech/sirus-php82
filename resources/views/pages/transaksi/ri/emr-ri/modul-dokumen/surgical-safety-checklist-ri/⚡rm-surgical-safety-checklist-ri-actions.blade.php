...
<div>
    ...
    <x-modal name="rm-surgical-safety-checklist-ri-{{ $riHdrNo ?? 'init' }}" size="full" height="full" focusable>
        <div class="relative flex flex-col min-h-[calc(100vh-8rem)]" wire:key="{{ $this->renderKey('modal-surgical-safety-checklist-ri', [$riHdrNo ?? 'new']) }}">
                    ...
                    <div>
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <p class="mt-0.5 text-xs text-muted dark:text-gray-400">Rawat Inap — WHO SSC</p>
                            </div>
                        </div>
