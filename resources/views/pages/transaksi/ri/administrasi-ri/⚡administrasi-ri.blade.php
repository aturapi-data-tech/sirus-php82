        ...
        <div class="flex flex-col min-h-[calc(100vh-8rem)]"
            ...
            <div class="sticky bottom-0 z-10 px-6 py-4 bg-canvas border-t border-hairline dark:bg-gray-900 dark:border-gray-700">
                <div class="flex items-center justify-between gap-2">
                    ...
                    @if ($riStatus === 'P')
                        <x-cetak-button wire:click="cetakRincianObat" label="Cetak Rincian Obat" />

                        <x-cetak-button wire:click="cetakKwitansiRingkas" label="Cetak Kwitansi (Ringkas)" />

                        <x-cetak-button wire:click="cetakKwitansi" label="Cetak Kwitansi (Detail)" />
                    @endif
