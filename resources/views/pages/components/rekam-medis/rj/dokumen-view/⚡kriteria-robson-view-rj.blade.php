<?php
// Viewer read-only "Kriteria Robson" — display Rekam Medis RJ.
...
new class extends Component {
    ...
    private string $filePrefix = 'kriteria-robson-rj';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-kriteria-robson-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-kriteria-robson-rj-{{ $rjNo }}" title="Kriteria Robson"
