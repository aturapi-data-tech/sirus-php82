<?php
// Viewer read-only "Surat Pernyataan Penolakan Tindakan Resusitasi (DNR)" — display Rekam Medis RI.
...
new class extends Component {
    ...
    private string $printView = 'penolakan-resusitasi-ri.cetak-penolakan-resusitasi-ri-print';
    private string $filePrefix = 'penolakan-resusitasi-ri';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-penolakan-resusitasi-ri-{$this->riHdrNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-penolakan-resusitasi-ri-{{ $riHdrNo }}" title="Penolakan Tindakan Resusitasi (DNR)"
