        ...
        <div class="flex flex-col min-h-[calc(100vh-4rem)]" wire:key="preview-rekam-medis-ri-{{ $riHdrNo }}"
            ...
            <div class="flex-1 overflow-y-auto bg-surface-soft/70 dark:bg-gray-950/20">
                ...
                @php
                    ...
                    // Label tujuan edukasi terintegrasi — satu sumber di App\Support\EdukasiTerintegrasiOptions
                    $tujuanLabels = \App\Support\EdukasiTerintegrasiOptions::tujuan();
                ...
                <div x-show="tab === 'dokumen'" x-cloak class="px-6 py-5 space-y-5">
                    ...
                    <livewire:pages::components.rekam-medis.r-i.dokumen-view.penolakan-obat-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    <livewire:pages::components.rekam-medis.r-i.dokumen-view.surveilans-hap-view-ri :riHdrNo="(string) $riHdrNo"
