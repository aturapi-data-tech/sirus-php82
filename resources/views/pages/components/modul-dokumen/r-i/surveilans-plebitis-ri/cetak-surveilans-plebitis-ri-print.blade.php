{{-- resources/views/pages/components/modul-dokumen/r-i/surveilans-plebitis-ri/cetak-surveilans-plebitis-ri-print.blade.php --}}
...
<x-pdf.layout-a4-with-out-background title="SURVEILANS HAIs — IADP & PLEBITIS">
    ...
    <table class="sv">
        <tr>
            <td class="lbl">Kultur Darah</td><td>{{ $nilai('kulturDarah') }}</td>
            <td class="lbl">Kultur Pus</td><td>{{ $nilai('kulturPus') }}</td>
        </tr>
