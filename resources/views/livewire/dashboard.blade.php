...
new class extends Component {
    ...
    public function masterMenus(): array
    {
        ...
        $rows = array_filter([
            // ── Master Klinik (data pelayanan & rekam medis) ──────────
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 1,  'route' => 'master.poli',              'title' => 'Master Poli',                    'desc' => 'Kelola data poli & ruangan',                                'roles' => ['admin'],                       'badge' => 'Klinik']),
            ...
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 4,  'route' => 'master.diagnosa',          'title' => 'Master Diagnosa',                'desc' => 'Kelola data diagnosa ICD-10',                               'roles' => ['admin'],                       'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 5,  'route' => 'master.radiologis',        'title' => 'Master Radiologi',               'desc' => 'Kelola data radiologi',                                     'roles' => ['admin'],                       'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 6,  'route' => 'master.others',            'title' => 'Master Lain-lain',               'desc' => 'Kelola data lain-lain',                                     'roles' => ['admin'],                       'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 7,  'route' => 'master.agama',             'title' => 'Master Agama',                   'desc' => 'Kelola data agama pasien',                                  'roles' => ['admin'],                       'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 8,  'route' => 'master.diag-keperawatan',  'title' => 'Master Diagnosis Keperawatan',   'desc' => 'Kelola data SDKI, SLKI, SIKI asuhan keperawatan',           'roles' => ['admin', 'perawat'],            'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 9,  'route' => 'master.kamar',             'title' => 'Master Kamar',                   'desc' => 'Kelola bangsal, kamar & bed rawat inap',                    'roles' => ['admin', 'mr', 'perawat'],      'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 10, 'route' => 'master.kelas',             'title' => 'Master Kelas Rawat',             'desc' => 'Kelola kelas kamar & mapping Aplicares / SIRS',             'roles' => ['admin'],                       'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 11, 'route' => 'master.karyawan',          'title' => 'Master Karyawan',                'desc' => 'Kelola NIK karyawan untuk login user & coder iDRG (E-Klaim)','roles' => ['admin'],                       'badge' => 'Klinik']),
            $entry(['group' => 'Master Klinik', 'groupOrder' => 1, 'order' => 12, 'route' => 'master.setup-jadwal-bpjs', 'title' => 'Pemetaan Jadwal Dokter',         'desc' => 'Ambil & terapkan jadwal praktek dokter dari BPJS ke data RS','roles' => ['admin', 'mr'],                 'badge' => 'BPJS']),
            ...
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 3, 'route' => 'keuangan.saldo-kas',          'title' => 'Saldo Kas',          'desc' => 'Posisi saldo kas/bank per tanggal — riwayat transaksi & edit saldo awal tahun (admin)','roles' => ['admin', 'tu'], 'badge' => 'SK']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 4, 'route' => 'keuangan.buku-besar',         'title' => 'Buku Besar',         'desc' => 'Mutasi & saldo per akun dalam periode tertentu',                                       'roles' => ['admin', 'tu'], 'badge' => 'BB']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 5, 'route' => 'keuangan.laba-rugi',          'title' => 'Laporan Laba Rugi',  'desc' => 'Pendapatan vs beban — laba/rugi periode berjalan',                                     'roles' => ['admin', 'tu'], 'badge' => 'LR']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 6, 'route' => 'keuangan.neraca',             'title' => 'Laporan Neraca',     'desc' => 'Posisi aktiva, kewajiban & modal per tanggal',                                         'roles' => ['admin', 'tu'], 'badge' => 'NRC']),
