...
new class extends Component {
    ...
    public function masterMenus(): array
    {
        return [
            ...
            ['group' => 'Sistem', 'groupOrder' => 7, 'order' => 4, 'title' => 'Role Control', 'desc' => 'Kelola role & permission sistem', 'href' => route('database-monitor.role-control'), 'roles' => ['admin'], 'badge' => 'ROL'],
        ];
    }
