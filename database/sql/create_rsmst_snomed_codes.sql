...
INSERT ALL
    ...
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('91930004',  'Allergy to egg',                        'Alergi telur',             'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('417532002', 'Allergy to fish',                       'Alergi ikan',              'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('300913006', 'Allergy to shrimp',                     'Alergi udang',             'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('735029006', 'Allergy to crab',                       'Alergi kepiting',          'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('414285001', 'Allergy to food',                       'Alergi makanan',           'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('425525006', 'Allergy to dairy product',              'Alergi susu/produk susu',  'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('89811004',  'Allergy to gluten',                     'Alergi gluten',            'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('91937001',  'Allergy to shellfish',                  'Alergi kerang',            'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('300916003', 'Allergy to chocolate',                  'Alergi cokelat',           'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('418184004', 'Allergy to soy protein',                'Alergi protein kedelai',   'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('782555009', 'Allergy to cow milk protein',            'Alergi protein susu sapi', 'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('390952000', 'Allergy to dust',                       'Alergi debu',              'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('419474003', 'Allergy to mold',                       'Alergi jamur/kapang',      'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('232350006', 'Allergy to cat dander',                 'Alergi bulu kucing',       'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('232349006', 'Allergy to dog dander',                 'Alergi bulu anjing',       'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('735030001', 'Cold urticaria',                        'Alergi udara dingin',      'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('402387002', 'Allergic contact dermatitis',            'Dermatitis kontak alergi', 'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('294716003', 'Allergy to sulfonamide',                'Alergi sulfonamida',       'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('293586001', 'Allergy to codeine',                    'Alergi kodein',            'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('293584003', 'Allergy to morphine',                   'Alergi morfin',            'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('294921000', 'Allergy to tetracycline',               'Alergi tetrasiklin',       'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('293963004', 'Allergy to gentamicin',                 'Alergi gentamisin',        'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('293747003', 'Allergy to insulin',                    'Alergi insulin',           'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('418038007', 'Allergy to propylene glycol',            'Alergi propilen glikol',   'substance-code')
    INTO rsmst_snomed_codes (snomed_code, display_en, display_id, value_set) VALUES ('418325008', 'Allergy to adhesive plaster',            'Alergi plester',           'substance-code')
SELECT 1 FROM DUAL;
